...
namespace :data do
  ...
  task :init_doc_meta => :environment do
    ...
    rd_split = DocRowMetaInfo.create :name=>'ReimSplitDetail',:display_name=>'费用分摊明细',:fi_adapt=>false,:hr_adapt=>false,:read_only_attrs => 'apply_amount,hr_amount,fi_amount'
    ...
    DocRelation.create :doc_meta_info => jk,:doc_row_meta_info => reciver,:doc_row_attrs=>%w(settlement_id company bank bank_no amount)
    ...
    DocRelation.create :doc_meta_info => cl,:doc_row_meta_info => reciver,:doc_row_attrs=>%w(settlement_id company bank bank_no amount)
    ...
    DocRelation.create :doc_meta_info => jj,:doc_row_meta_info => reciver,:doc_row_attrs=>%w(settlement_id company bank bank_no amount)
    ...
    DocRelation.create :doc_meta_info => pt,:doc_row_meta_info => reciver,:doc_row_attrs=>%w(settlement_id company bank bank_no amount)
