...
describe "busi_communications/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit busi_communication form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => busi_communications_path(@busi_communication), :method => "post" do
