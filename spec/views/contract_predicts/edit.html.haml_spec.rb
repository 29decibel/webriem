...
describe "contract_predicts/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit contract_predict form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => contract_predicts_path(@contract_predict), :method => "post" do
