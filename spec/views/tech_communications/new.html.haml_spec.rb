...
describe "tech_communications/new.html.haml" do
  before(:each) do
    assign(:tech_communication, stub_model(TechCommunication,
      :phone => "MyString",
      :duty => "MyString",
      :contents => "MyString",
      :feedback => "MyString",
  ...
  it "renders new tech_communication form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => tech_communications_path, :method => "post" do
