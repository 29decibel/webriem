...
describe "network_conditions/new.html.haml" do
  before(:each) do
    assign(:network_condition, stub_model(NetworkCondition,
      :ip_address => "MyString",
      :hub => "MyString",
      :dns_server => "MyString",
  ...
  it "renders new network_condition form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => network_conditions_path, :method => "post" do
