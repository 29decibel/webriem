...
describe "product_tests/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit product_test form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => product_tests_path(@product_test), :method => "post" do
