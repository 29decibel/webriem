...
describe "doc_amount_changes/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit doc_amount_change form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => doc_amount_changes_path(@doc_amount_change), :method => "post" do
